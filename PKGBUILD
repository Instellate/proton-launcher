...
depends=('qt6-base' 'qt6-declarative' 'qcoro' 'ki18n' 'kiconthemes' 'kcrash' 'kconfig' 'kcoreaddons' 'qqc2-desktop-style' 'kirigami' 'kirigami-addons' 'karchive' 'kstatusnotifieritem' 'vulkan-driver' 'lib32-libglvnd' 'lib32-vulkan-driver')
